...
public class TestBot {
    ...
    public static void main(final String[] args) {
        Bot bot;
        bot = NetworkFileManager.loadBot(200);
        ...
        for (;;) {
            ...
            for (final Ship ship : me.ships.values()) {
                ...
                setShipData(gameMap, ship, enemyShip.position, allyShipPos, drop.position);
    ...
    private static Entity getClosestDrop(Player me, Ship ship) {
        ...
        if (drop == null) {
            ...
            drop = dist(ship.position, drop.position) > dist(ship.position, me.shipyard.position) ? me.shipyard : drop;
        }
        return drop;
    }
    ...
    private static <T> Entity closest(Entity entity, Map<EntityId, T> entityMap) {
        if (entityMap.isEmpty()) {
            ...
            int closestDist = dist(entity.position, closest.position);
